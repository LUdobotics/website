          ...
          <div className="overflow-hidden rounded-2xl border border-ludo-cyan/25 bg-[#06101d]/95 shadow-[0_0_60px_rgba(0,255,255,0.08)]">
            ...
            >
              ...
              <span className="flex shrink-0 flex-wrap items-center justify-end gap-3 self-end sm:self-auto">
                ...
                <span className="inline-flex items-center gap-2 rounded-lg border border-ludo-cyan bg-ludo-cyan px-4 py-3 font-orbitron text-[10px] font-bold uppercase tracking-wider text-ludo-deep shadow-[0_0_24px_rgba(0,255,255,0.22)] transition group-hover:bg-white group-hover:border-white">
